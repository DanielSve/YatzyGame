...
public class LabelGenerator extends JLabel {
    ...
    public LabelGenerator(String player){
        ...
        label4 = new JLabel();
        label5 = new JLabel();
        label1.setIcon(new ImageIcon("dice1.jpg"));
        label2.setIcon(new ImageIcon("dice2.jpg"));
        label3.setIcon(new ImageIcon("dice3.jpg"));
        label4.setIcon(new ImageIcon("dice4.jpg"));
        label5.setIcon(new ImageIcon("dice5.jpg"));
